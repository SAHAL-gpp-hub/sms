...
\restrict aJBiJetj013C1iC6tJfwma8jttyhvA3iEE9XpfkL2KFUwK0sV2rvdciGSxUL2cY
...
CREATE TABLE public.exam_subject_configs (
    ...
    max_practical integer NOT NULL
);
...
--
-- Name: token_blocklist token_blocklist_jti_key; Type: CONSTRAINT; Schema: public; Owner: sms_user
--
...
--
-- Name: students students_parent_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: sms_user
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_parent_user_id_fkey FOREIGN KEY (parent_user_id) REFERENCES public.users(id);


--
-- Name: students students_student_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: sms_user
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_student_user_id_fkey FOREIGN KEY (student_user_id) REFERENCES public.users(id);
...
\unrestrict aJBiJetj013C1iC6tJfwma8jttyhvA3iEE9XpfkL2KFUwK0sV2rvdciGSxUL2cY
