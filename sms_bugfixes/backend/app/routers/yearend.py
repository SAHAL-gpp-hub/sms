...
def promote_class(
    ...
    """
    BUG 3 FIX: service now raises ValueError for unrecognised class names
    and returns {"error": "..."} for both end-of-ladder and unknown-name cases.
    Both are surfaced as HTTP 400 with the specific error message.
    """
