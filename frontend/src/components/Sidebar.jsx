 ...
 * Sidebar Component
 * 
 * Main navigation sidebar for School Management System
 * Features:
 * - Responsive design
    ...
    <aside className="w-60 min-h-screen bg-white border-r border-slate-200 flex flex-col shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          {/* School Logo */}
          <div className="w-9 h-9 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="px-4 py-4 border-t border-slate-100 bg-slate-50">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white transition-colors cursor-pointer">
          {/* Avatar */}
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate">GSEB · 2025–26</p>
          </div>
