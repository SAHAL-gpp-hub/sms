// api.js — Fixed & improved API service layer
...
// FIX: Auto-logout on 401 (expired token) instead of showing cryptic errors
...
export const marksAPI = {
  ...
  getMarksGrid: (examId, classId) => api.get('/marks/grid', { params: { exam_id: examId, class_id: classId } }),
...
// Helper: extract human-readable error from FastAPI response
