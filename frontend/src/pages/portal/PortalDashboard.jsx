  ...
  return (
    <>
      <style>{`
        ...
        .portal-dashboard-shell { display: grid; gap: 14px; }
        .portal-dashboard-content { display: grid; gap: 14px; }
        .portal-dashboard-primary,
        .portal-dashboard-secondary { display: grid; gap: 14px; }
        ...
        .portal-dashboard-quick-links {
          display: grid;
          grid-template-columns: 1fr 1fr;
          gap: 8px;
        }
        @media (min-width: 900px) {
          .portal-dashboard-shell { gap: 18px; }
          .portal-dashboard-content {
            grid-template-columns: minmax(0, 1.45fr) minmax(270px, 0.8fr);
            align-items: start;
            gap: 16px;
          }
          .portal-dashboard-stats { gap: 12px; }
      ...
      <div className="portal-dashboard-shell">
        ...
        <div className="portal-dashboard-content">
          <div className="portal-dashboard-primary">
            ...
            {/* Stats */}
            <div className="portal-dashboard-stats">
              {loading ? (
          ...
          <aside className="portal-dashboard-secondary">
            {/* Quick links */}
            <div style={{ background: 'white', borderRadius: '14px', padding: '14px', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
              ...
              <div className="portal-dashboard-quick-links">
                {[
